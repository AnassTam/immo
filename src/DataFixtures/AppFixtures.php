    ...
    public function load(ObjectManager $manager)
    {
        ...
        for($i = 0 ; $i<=100 ; $i++) {
            ...
            $house
                ...
                ->setReference($faker->numberBetween(100000,900000))
                ->setPrix($faker->numberBetween(800000, 600000))
                ->setLocalisation($faker->randomElement($city))
                ->setPiece($faker->numberBetween(1, 15))
        ...
        // fixture Appartement
        for($i = 0 ; $i<=100 ; $i++) {
            $house = new Appartement();
            $house->setAnneeRenovation($faker->numberBetween(1990,2020))
